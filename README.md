...
B. STEP 2 — Open Git Bash Inside the Folder
...
C. STEP 3 — Set Your Git Identity (Required Once Only)
...
D. STEP 4 — Initialize Git in Your Folder
Run:
git init
This creates a hidden .git folder where Git tracks all your project data.
You will see a message:
Initialized empty Git repository in .../.git/
E. STEP 5 — Add Files and Make Your First Commit
Add all files:
git add .
...
F. STEP 6 — Create Your GitHub Repository
...
G. STEP 7 — Connect Local Git to GitHub
...
H. STEP 8 — Create README.md (Professional Format)
Create a new file in your project folder called README.md and paste:
J. STEP 9 — Commit and Push README.md
Add the README:
git add README.md
Commit it:
